...
<p>
  📚 Estructuras de Datos en Python son formas específicas de organizar y almacenar datos 
  en la memoria para que puedan ser utilizados de manera eficiente.
</p>
...
1. Clona el repositorio:
    ...
    ```
    git clone https://github.com/Bredalis/DataStructure.git
    ```
